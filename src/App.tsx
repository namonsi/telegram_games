...
const KINDS: GameKind[] = ['number', 'knowme', 'battleship', 'twenty', 'mystery', 'quiz', 'wordduel', 'emoji', 'crazy8s', 'heist'];
...
export default function App({ me }: { me: Me }) {
  ...
  const screen = () => {
    ...
    switch (room.kind) {
      ...
      case 'heist':
        return <Heist meId={me.id} room={room} onUpdate={applyRoom} />;
    }
  };
