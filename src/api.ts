...
export const api = {
  ...
  placeOthello: (roomId: string, cell: number) => post<OthelloRoom>({ action: 'placeOthello', roomId, cell }),
  placeGomoku: (roomId: string, cell: number) => post<GomokuRoom>({ action: 'placeGomoku', roomId, cell }),
